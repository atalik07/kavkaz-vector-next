...
/>
              ...
              <div className="mt-6 flex flex-col gap-3 px-4 sm:flex-row sm:items-start sm:gap-6" data-reveal data-reveal-delay="2">
                <button
                  type="submit"
              ...
              {sent ? (
                <div className="mt-4 text-base text-black/60 dark:text-white/70" data-reveal data-reveal-delay="3">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            >
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between" data-reveal data-reveal-delay="2">
                <a
                  href={telegramHref}
                  target="_blank"
                  rel="noreferrer"
